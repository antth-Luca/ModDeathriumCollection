...
public class DeathRingItem extends RelicItem {
    public DeathRingItem() {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag tooltipFlag) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("item.deathrium_collection.death_ring.tooltip.passive").withStyle(ChatFormatting.GRAY));
        } else {
            tooltip.add(Component.translatable("item.deathrium_collection.death_ring.tooltip.lore"));
