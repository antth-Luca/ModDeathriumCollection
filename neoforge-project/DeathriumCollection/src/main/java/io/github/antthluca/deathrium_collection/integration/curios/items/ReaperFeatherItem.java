...
public class ReaperFeatherItem extends RelicItem {
    public ReaperFeatherItem() {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag tooltipFlag) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("item.deathrium_collection.reaper_feather.tooltip.passive").withStyle(ChatFormatting.GRAY));
        } else {
            tooltip.add(Component.translatable("item.deathrium_collection.reaper_feather.tooltip.lore"));
