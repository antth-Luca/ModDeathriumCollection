...
public class BlackHeartItem extends RelicItem {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag tooltipFlag) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("item.deathrium_collection.black_heart.tooltip.passive").withStyle(ChatFormatting.GRAY));
        } else {
            tooltip.add(Component.translatable("item.deathrium_collection.black_heart.tooltip.lore"));
